...
public class EventData {
    ...
    private String url = "https://q2e4y7sz9h.execute-api.us-west-2.amazonaws.com/staging/events/?longitude="+longitude+"&latitude="+latitude;

    public List<mEvent> getEvents(final EventListAsyncResponse callBack) {
